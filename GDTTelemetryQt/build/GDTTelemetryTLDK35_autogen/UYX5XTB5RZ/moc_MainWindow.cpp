...
template <> constexpr inline auto GDT::MainWindow::qt_create_metaobjectdata<qt_meta_tag_ZN3GDT10MainWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(GDT::DataTelemetry)>(10, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 11, 12 },
        }}),
        // Slot 'on5A42Received'
        QtMocHelpers::SlotData<void(GDT::Data5A42)>(13, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 14, 12 },
        }}),
        // Slot 'on5U44Received'
        QtMocHelpers::SlotData<void(GDT::Data5U44)>(15, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 16, 12 },
        }}),
        // Slot 'on5E15Received'
        QtMocHelpers::SlotData<void(GDT::Data5E15)>(17, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 18, 12 },
        }}),
...
void GDT::MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->onStartLog(); break;
        case 3: _t->onStopLog(); break;
        case 4: _t->onSetupServer(); break;
        case 5: _t->onSetup5A42(); break;
        case 6: _t->onReset(); break;
        case 7: _t->onShow5A42Detail(); break;
        case 8: _t->onTelemetryReceived((*reinterpret_cast<std::add_pointer_t<GDT::DataTelemetry>>(_a[1]))); break;
        case 9: _t->on5A42Received((*reinterpret_cast<std::add_pointer_t<GDT::Data5A42>>(_a[1]))); break;
        case 10: _t->on5U44Received((*reinterpret_cast<std::add_pointer_t<GDT::Data5U44>>(_a[1]))); break;
        case 11: _t->on5E15Received((*reinterpret_cast<std::add_pointer_t<GDT::Data5E15>>(_a[1]))); break;
        case 12: _t->onClientConnected((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 13: _t->onClientDisconnected((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
}
