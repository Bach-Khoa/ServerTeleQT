...
public:
    ...
    void write5I41(const Data5I41Block& d);
...
private:
    ...
    QFile       m_fileTele,  m_file5A42, m_file5U44, m_file5I41, m_file5E15;
    QTextStream m_stTele,    m_st5A42,   m_st5U44,   m_st5I41,   m_st5E15;
    bool        m_open = false;
