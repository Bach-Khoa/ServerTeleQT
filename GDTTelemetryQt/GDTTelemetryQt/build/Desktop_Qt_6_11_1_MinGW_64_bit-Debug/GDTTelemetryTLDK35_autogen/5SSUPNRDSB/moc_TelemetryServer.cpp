...
template <> constexpr inline auto GDT::ClientWorker::qt_create_metaobjectdata<qt_meta_tag_ZN3GDT12ClientWorkerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'data5I41Received'
        QtMocHelpers::SignalData<void(GDT::Data5I41Block)>(9, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 10, 4 },
        }}),
        ...
        // Slot 'updateCalib'
        QtMocHelpers::SlotData<void(GDT::Calib5A42)>(13, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 14, 15 },
        }}),
        // Slot 'onReadyRead'
...
void GDT::ClientWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->data5I41Received((*reinterpret_cast<std::add_pointer_t<GDT::Data5I41Block>>(_a[1]))); break;
        case 4: _t->clientDisconnected((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 5: _t->updateCalib((*reinterpret_cast<std::add_pointer_t<GDT::Calib5A42>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (ClientWorker::*)(GDT::Data5U44 )>(_a, &ClientWorker::data5U44Received, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (ClientWorker::*)(GDT::Data5I41Block )>(_a, &ClientWorker::data5I41Received, 3))
            return;
        if (QtMocHelpers::indexOfMethod<void (ClientWorker::*)(QString )>(_a, &ClientWorker::clientDisconnected, 4))
            return;
    }
}
...
// SIGNAL 3
void GDT::ClientWorker::data5I41Received(GDT::Data5I41Block _t1)
{
...
template <> constexpr inline auto GDT::TelemetryServer::qt_create_metaobjectdata<qt_meta_tag_ZN3GDT15TelemetryServerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'calibUpdated'
        QtMocHelpers::SignalData<void(GDT::Calib5A42)>(16, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 17, 18 },
        }}),
...
void GDT::TelemetryServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->data5U44Received((*reinterpret_cast<std::add_pointer_t<GDT::Data5U44>>(_a[1]))); break;
        case 3: _t->data5I41Received((*reinterpret_cast<std::add_pointer_t<GDT::Data5I41Block>>(_a[1]))); break;
        case 4: _t->clientConnected((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 5: _t->clientDisconnected((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 6: _t->serverError((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 7: _t->calibUpdated((*reinterpret_cast<std::add_pointer_t<GDT::Calib5A42>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (TelemetryServer::*)(GDT::Data5U44 )>(_a, &TelemetryServer::data5U44Received, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (TelemetryServer::*)(GDT::Data5I41Block )>(_a, &TelemetryServer::data5I41Received, 3))
            return;
        if (QtMocHelpers::indexOfMethod<void (TelemetryServer::*)(QString )>(_a, &TelemetryServer::clientConnected, 4))
            return;
        if (QtMocHelpers::indexOfMethod<void (TelemetryServer::*)(QString )>(_a, &TelemetryServer::clientDisconnected, 5))
            return;
        if (QtMocHelpers::indexOfMethod<void (TelemetryServer::*)(QString )>(_a, &TelemetryServer::serverError, 6))
            return;
        if (QtMocHelpers::indexOfMethod<void (TelemetryServer::*)(GDT::Calib5A42 )>(_a, &TelemetryServer::calibUpdated, 7))
            return;
    }
}
...
// SIGNAL 3
void GDT::TelemetryServer::data5I41Received(GDT::Data5I41Block _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 3, nullptr, _t1);
}
